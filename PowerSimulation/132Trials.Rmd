...
source("/Users/au571533/Dropbox/PowerSimulation/functions/SimData.R")
source("/Users/au571533/Dropbox/PowerSimulation/functions/CompPowerAll.R")
#source("/Users/au571533/Dropbox/PowerSimulation/functions/CompPower2.R")
...
for (n in n_subj)
{
  ...
  outcome <- power_all(J = n, K = 132, C = 3, beta = c(0, -0.5, -0.5, 0.5, 0.5), n.sims = 100)
...
for (n in n_subj)
{
  ...
  # Store values and add to dataframe
  outcome <- power_all(J = n, K = 132, C = 3, beta = c(0, -0.7, -0.7, 0.7, 0.7), n.sims = 100)
